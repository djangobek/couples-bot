import { createDateSchema, updateDateSchema, dateIdSchema, } from "@couples/shared";
...
export async function registerDateRoutes(app) {
    /* ---------- GET /v1/dates ---------- */
    ...
    /* ---------- POST /v1/dates ---------- */
    app.post("/v1/dates", { preHandler: requireCouple }, async (request) => {
        const auth = requireAuth(request);
