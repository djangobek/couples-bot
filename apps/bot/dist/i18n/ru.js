...
export const ru = {
    ...
    help: {
        ...
        gamesHelp: "💣 <b>Бомба:</b> <code>bomb_XXXXXX</code>\n⭕ <b>X-O:</b> <code>ttt_XXXXXX</code>",
    },
    subscription: {
        title: "📢 <b>Обязательная подписка</b>",
        description: "Для использования бота подпишитесь на следующие каналы:",
        ...
        channelError: "⚠️ Ошибка при проверке каналов. Пожалуйста, попробуйте позже",
    },
    profile: {
